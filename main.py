...
def run_model(siamese, distance_type):
	...
	if siamese:
		siamese_model.train(X_train, X_val, X_test, y_train, y_val, y_test, embedding_matrix, distance_type)
...
def main(args): 
	...
	run_model(args.siamese, args.distance_type)
